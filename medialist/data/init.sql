...
INSERT INTO Oeuvre(numero, titre, lien_photo, synopsis, date_sortie) VALUES (6,'Wonder Woman 2','img/wonderwoman2.jpg','Suite des aventures de Diana Prince, alias Wonder Woman, Amazone devenue une super-héroïne dans notre monde.','2000/01/01');
INSERT INTO Oeuvre(numero, titre, lien_photo, synopsis, date_sortie) VALUES (7,'Forrest Gump','img/forrestgump.jpg','Au fil des différents interlocuteurs qui viennent s''asseoir tour à tour à côté de lui sur un banc, Forrest Gump raconte la fabuleuse histoire de sa vie. Sa vie est à l''image d''une plume qui se laisse porter par le vent, tout comme Forrest se laisse porter par les événements qu''il traverse dans l''Amérique de la seconde moitié du 20e siècle.','2000/01/01');
INSERT INTO Oeuvre(numero, titre, lien_photo, synopsis, date_sortie) VALUES (8,'La Ligne verte','img/laligneverte.jpg','Paul Edgecomb, pensionnaire centenaire d''une maison de retraite, est hanté par ses souvenirs. Gardien-chef du pénitencier de Cold Mountain, en 1935, en Louisiane, il était chargé de veiller au bon déroulement des exécutions capitales au bloc E (la ligne verte) en s''efforçant d''adoucir les derniers moments des condamnés. Parmi eux se trouvait un colosse du nom de John Coffey, accusé du viol et du meurtre de deux fillettes.','2000/01/01');
INSERT INTO Oeuvre(numero, titre, lien_photo, synopsis, date_sortie) VALUES (9,'Titanic','img/titanic.jpg','En 1997, l''épave du Titanic est l''objet d''une exploration fiévreuse, menée par des chercheurs de trésor en quête d''un diamant bleu qui se trouvait à bord. Frappée par un reportage télévisé, l''une des rescapés du naufrage, âgée de 102 ans, Rose DeWitt, se rend sur place et évoque ses souvenirs. 1912. Fiancée à un industriel arrogant, Rose croise sur le bateau un artiste sans le sou.','2000/01/01');
INSERT INTO Oeuvre(numero, titre, lien_photo, synopsis, date_sortie) VALUES (10,'Star Wars IV: Un nouvel espoir','img/starwars4.jpg','Il y a bien longtemps, dans une galaxie très lointaine. La guerre civile fait rage entre l''Empire galactique et l''Alliance rebelle. Capturée par les troupes de choc de l''Empereur menées par le sombre et impitoyable Dark Vador, la princesse Leia Organa dissimule les plans de l''Etoile Noire, une station spatiale invulnérable, à son droïde R2-D2 avec pour mission de les remettre au Jedi Obi-Wan Kenobi.','2000/01/01');
...
INSERT INTO Oeuvre(numero, titre, lien_photo, synopsis, date_sortie) VALUES (12,'OSS 117: Alerte rouge en Afrique noire','img/oss117.jpg','L''intrigue d''OSS 117 : Alerte rouge en Afrique Noire se déroulera dans les années 1970-1980, à la différence des deux précédents films qui prenaient place entre le milieu des années 1950 et 1960.','2000/01/01');
INSERT INTO Oeuvre(numero, titre, lien_photo, synopsis, date_sortie) VALUES (13,'Fast and Furious 9','img/fastandfurious.jpg','Dominic Toretto et son équipe unissent leurs forces pour combattre l''assassin le plus habile et le conducteur le plus performant qu''ils aient jamais rencontré : son frère abandonné.','2000/01/01');
INSERT INTO Oeuvre(numero, titre, lien_photo, synopsis, date_sortie) VALUES (14,'L''énigme de la chambre 622','img/chambre622.jpg','L''Énigme de la Chambre 622. Résumé : Une nuit de décembre, un meurtre a lieu au Palace de Verbier, dans les Alpes suisses. L''enquête de police n''aboutira jamais.','2000/01/01');
INSERT INTO Oeuvre(numero, titre, lien_photo, synopsis, date_sortie) VALUES (15,'West Side Story','img/westsidestory.jpg','Upper West Side, années 1950. Deux bandes de jeunes s''affrontent : d''un côté les Sharks dirigés par Bernardo et de l''autre les Jets, avec Riff à leur tête. Tony, lié au Jets, va s''éprendre de Maria, la sœur de Bernardo.','2000/01/01');
...
insert into Commentaire (pseudo,numero,alerte,texte,date_com) values ('Dior Bronze',5,'vulgarité','De la merde','2000/01/01');
insert into Commentaire (pseudo,numero, texte,date_com) values ('Pain Reli',1,'Dommage que la fin ai été bâclée, sinon pas mal','2000/01/01');
